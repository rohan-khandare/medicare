...
const Signup = () => {
  ...
  return (
  <section className="px-5 xl:px-0 my-[-50px]">
    <div className="max-w-[1170px] mx-auto">
      <div className="grid grid-cols-1 lg:grid-cols-2">
        {/* ======== img box ======== */}
        <div className="hidden lg:block bg-primaryColor rounded-l-lg h-[500px]">
          <figure className="hidden-l-lg">
          ...
          <form action="" onSubmit={submitHandler} >
            ...
            <div className='mb-5 flex items-center gap-3'>
              ...
              <p className="mt-5 text-textColor text-center">
                ...
                className="text-primaryColor">Login</Link>
              </p>              
            <div/>
          </form>
        </div>
