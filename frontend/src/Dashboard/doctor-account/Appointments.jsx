...
//             <tr>
//                 <th scope="col" className="px6 py-3">Name</th>
//                 <th scope="col" className="px6 py-3">Gender</th>
//                 <th scope="col" className="px6 py-3">Payment</th>
//                 <th scope="col" className="px6 py-3">Price</th>
//                 <th scope="col" className="px6 py-3">Booked on</th>            
//             </tr>
//         </thead>
