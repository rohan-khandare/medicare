...
const Dashboard = () => {
  ...
  const {data, loading, error} =useGetProfile(`${BASE_URL}/doctors/profile`,userId);
  console.log(data);
            ...
            <div className="flex p-4 mb-4 text-yellow-800 bg-yellow-50 rounded-lg">
              ...
              >
                <path
                  ...
                  2v3aa1 1 0 001 1h1a1 1 0 100-2v-3a1 1 0 00-1-1h9z"
                  clipRule="evenodd"
                ></path>
              </svg>
                ...
                <div className="flex items-center gap-4 mb-10">
                  ...
                  <div>
                    ...
                    <div className='flex item-center gap-[6px]'>
                      <span className='flex item-center gap-[6px] text-headingColor text-[14px] leading-5
